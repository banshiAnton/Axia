...
LABEL maintainer="AXIA Search <${GIT_URL}>" \
      ...
      org.label-schema.usage="https://git.ajhs.io/alexsteffen/asearch-dockerr" \
      ...
      org.opencontainers.image.documentation="https://git.ajhs.io/alexsteffen/asearch-docker"
